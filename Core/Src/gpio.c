...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USS_TRIG_GPIO_Port, USS_TRIG_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : SIDE_IR_RIGHT_ADC_Pin */
  GPIO_InitStruct.Pin = SIDE_IR_RIGHT_ADC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SIDE_IR_RIGHT_ADC_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : USS_TRIG_Pin */
  GPIO_InitStruct.Pin = USS_TRIG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USS_TRIG_GPIO_Port, &GPIO_InitStruct);
